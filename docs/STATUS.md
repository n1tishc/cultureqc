...
Tests: `pytest tests` → 82 passed, 1 xfailed (2026-09-25, after A2, A5 and the one-step prediction).
...
| A0.5 `nb/03` Colab run | **Being run by you on Colab** (from 2026-09-25). First run stopped at checkpoint 1 (`mode: unknown`: sequences are nested OSF components); fixed in `da93477`, notebook repinned |
